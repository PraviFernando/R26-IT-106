...
const s = StyleSheet.create({
  ...
  tabBtnActive: { backgroundColor: '#AA60C8', borderColor: '#AA60C8' },
  tabBtnText: { fontSize: 12, fontFamily: typography.subTopicFont, fontWeight: '600', color: '#6A4D77' },
  ...
  widgetLabel: { fontSize: 10, fontFamily: typography.bodyFont, color: '#6A4D77', fontWeight: '600', textAlign: 'center', marginTop: 4 },
  chartCard: { backgroundColor: '#FFFFFF', borderRadius: radius.xl, padding: spacing.lg, marginBottom: spacing.md, borderWidth: 1, borderColor: '#EABDE6', ...shadows.card },
  ...
  barDay: { fontSize: 9, fontFamily: typography.bodyFont, color: '#9E7FA9', marginTop: 4, fontWeight: '600' },
  barDayToday: { color: '#AA60C8', fontWeight: '700' },
  legend: { flexDirection: 'row', justifyContent: 'space-around', paddingTop: spacing.sm, borderTopWidth: 1, borderTopColor: '#FAF2FA' },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  legendEmoji: { fontSize: 13 },
  legendLabel: { fontSize: 9, fontFamily: typography.bodyFont, color: '#9E7FA9' },
  emotionRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  emotionEmoji: { width: 120, fontSize: 12, fontFamily: typography.subTopicFont, fontWeight: '600', color: '#6A4D77' },
  emotionTrackBg: { flex: 1, height: 8, borderRadius: radius.full, backgroundColor: '#FFDFEF', overflow: 'hidden' },
  emotionTrackFill: { height: 8, borderRadius: radius.full },
  emotionCountVal: { width: 30, fontSize: 12, fontFamily: typography.bodyFont, color: '#6A4D77', textAlign: 'right', fontWeight: '700' },
  riskRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  riskChip: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: radius.full },
  riskChipText: { fontSize: 11, fontFamily: typography.subTopicFont, fontWeight: '700' },
  riskDisclaimer: { fontSize: 9, fontFamily: typography.bodyFont, color: '#9E7FA9', fontStyle: 'italic', marginTop: 10 },
  progressSummaryLine: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  progressLabelEn: { fontSize: 12, fontFamily: typography.bodyFont, color: '#6A4D77', fontWeight: '500' },
  progressValEn: { fontSize: 13, fontFamily: typography.subTopicFont, fontWeight: '700', color: '#2C1A35' },
  insightCard: { backgroundColor: '#FFFFFF', borderRadius: radius.xl, padding: spacing.lg, marginBottom: spacing.lg, ...shadows.soft, borderLeftWidth: 4, borderLeftColor: '#AA60C8', borderWidth: 1, borderColor: '#F5D3EE' },
  insightTitle: { fontSize: 14, fontFamily: typography.topicFont, fontWeight: '700', color: '#2C1A35', marginBottom: spacing.xs },
  insightText: { fontSize: 12, fontFamily: typography.bodyFont, color: '#6A4D77', lineHeight: 18, marginTop: 4 },
  centerScreen: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#FAF2FA' },
  centerText: { marginTop: 12, fontSize: 14, fontFamily: typography.bodyFont, color: '#6A4D77', fontWeight: '600' },
  retryBtn: { marginTop: 16, paddingVertical: 10, paddingHorizontal: 20, borderRadius: radius.full, backgroundColor: '#AA60C8' },
  retryText: { color: '#FFFFFF', fontFamily: typography.subTopicFont, fontWeight: '700', fontSize: 12 },
  emptyStateBox: { backgroundColor: '#FFFFFF', borderRadius: radius.xl, padding: spacing.xl, alignItems: 'center', marginBottom: spacing.lg, borderWidth: 1, borderColor: '#F5D3EE', ...shadows.soft },
  emptyStateTextHeader: { fontSize: 18, fontFamily: typography.topicFont, fontWeight: '700', color: '#2C1A35', marginBottom: 8 },
  emptyStateBtn: { paddingVertical: 12, paddingHorizontal: 24, borderRadius: radius.full, backgroundColor: '#AA60C8', ...shadows.soft },
  emptyStateBtnText: { color: '#FFFFFF', fontFamily: typography.subTopicFont, fontWeight: '700', fontSize: 13 },
  emptyStateLabel: { fontSize: 12, fontFamily: typography.bodyFont, color: '#9E7FA9', fontStyle: 'italic', textAlign: 'center', paddingVertical: 6 },
  badgeMetricsBox: { flexDirection: 'row', gap: 6, marginBottom: spacing.lg },
  badgeMetricCell: { flex: 1, backgroundColor: '#FFDFEF', borderRadius: radius.md, padding: 10, alignItems: 'center', borderWidth: 1, borderColor: '#EABDE6' },
  badgeMetricNum: { fontSize: 22, fontFamily: typography.topicFont, fontWeight: '700', color: '#2C1A35' },
  badgeMetricLabel: { fontSize: 9, fontFamily: typography.bodyFont, color: '#6A4D77', fontWeight: '600', textAlign: 'center', marginTop: 4 },
  badgeSubHeader: { fontSize: 13, fontFamily: typography.subTopicFont, fontWeight: '700', color: '#6A4D77', borderTopWidth: 1, borderTopColor: '#FAF2FA', paddingTop: spacing.md },
  badgeEmptyLabel: { fontSize: 12, fontFamily: typography.bodyFont, color: '#9E7FA9', fontStyle: 'italic', marginTop: 8 },
  badgeUnlockCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: radius.lg, padding: 10, borderWidth: 1, borderColor: '#F5D3EE' },
  badgeUnlockIcon: { fontSize: 26, marginRight: 10 },
  badgeUnlockTitle: { fontSize: 12, fontFamily: typography.subTopicFont, fontWeight: '700', color: '#2C1A35' },
  badgeUnlockTitleLocked: { fontSize: 12, fontFamily: typography.bodyFont, fontWeight: '600', color: '#9E7FA9' },
  badgeUnlockDesc: { fontSize: 10, fontFamily: typography.bodyFont, color: '#9E7FA9', marginTop: 2 },
  badgeEarnedBadge: { backgroundColor: '#FFDFEF', paddingVertical: 4, paddingHorizontal: 10, borderRadius: radius.full, borderWidth: 1, borderColor: '#EABDE6' },
  badgeEarnedText: { fontSize: 10, fontFamily: typography.subTopicFont, color: '#AA60C8', fontWeight: '700' },
  badgeProgressBarContainer: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 6 },
  badgeProgressBarBg: { flex: 1, height: 6, backgroundColor: '#FFDFEF', borderRadius: radius.full, overflow: 'hidden' },
  badgeProgressBarFill: { height: 6, backgroundColor: '#AA60C8', borderRadius: radius.full },
  badgeProgressText: { fontSize: 9, fontFamily: typography.bodyFont, fontWeight: '700', color: '#6A4D77', width: 26, textAlign: 'right' },
  filterRow: { flexDirection: 'row', gap: 6, marginBottom: spacing.md },
  filterBtn: { flex: 1, paddingVertical: 8, borderRadius: radius.full, backgroundColor: '#FFFFFF', alignItems: 'center', borderWidth: 1, borderColor: '#EABDE6' },
  filterBtnActive: { backgroundColor: '#AA60C8', borderColor: '#AA60C8' },
  filterBtnText: { fontSize: 10, fontFamily: typography.subTopicFont, fontWeight: '600', color: '#6A4D77' },
  filterBtnTextActive: { color: '#FFFFFF', fontWeight: '700' },
  detailProgCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#FAF2FA' },
  detailProgLeft: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 },
  detailProgIconBg: { width: 36, height: 36, borderRadius: 10, backgroundColor: '#FFDFEF', justifyContent: 'center', alignItems: 'center' },
  detailProgTitle: { fontSize: 12, fontFamily: typography.subTopicFont, fontWeight: '700', color: '#2C1A35' },
  detailProgSubText: { fontSize: 10, fontFamily: typography.bodyFont, color: '#6A4D77', marginTop: 2 },
  detailProgBarBg: { height: 4, backgroundColor: '#FFDFEF', borderRadius: radius.full, overflow: 'hidden', marginTop: 4, width: '90%' },
  detailProgBarFill: { height: 4, borderRadius: radius.full },
  detailProgDateLabel: { fontSize: 9, fontFamily: typography.bodyFont, color: '#9E7FA9', width: 70, textAlign: 'right' }
});
