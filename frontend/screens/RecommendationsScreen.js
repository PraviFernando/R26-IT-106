...
import {
  ...
  StyleSheet, Linking, Alert, Modal, TextInput,
...
const s = StyleSheet.create({
  ...
  modalCard: { backgroundColor: colors.white, borderRadius: radius.xl, padding: 20, width: '100%', maxWidth: 400, maxHeight: '85%', ...shadows.card },
