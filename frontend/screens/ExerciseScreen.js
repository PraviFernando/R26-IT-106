...
import {
    ...
    Image, FlatList, Platform, Linking, useWindowDimensions,
} from 'react-native';
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.videoModalContent}>
                        ...
                        >
                            ...
                            {selectedVideo && (
                                <View style={[styles.modalSplitRow, wideModal && styles.modalSplitRowWide]}>
                                    <View style={[styles.modalLeftColumn, wideModal && styles.modalLeftColumnWide]}>
                                    ...
                                    <View style={[styles.modalRightColumn, wideModal && styles.modalRightColumnWide]}>
                                        {/* Stopwatch UI */}
...
const styles = StyleSheet.create({
    // Layout
    safe: { flex: 1 },
    gradient: { flex: 1, backgroundColor: '#F7F3FF' },
    header: {
    ...
    statBox: {
        ...
        alignItems: 'center', minWidth: 100, elevation: 2,
    ...
    videoPlayer: { width: '100%', aspectRatio: 16 / 9, maxHeight: 460, borderRadius: 20, marginBottom: 16, backgroundColor: '#000' },
    ...
    questionsModalContent: {
        ...
        width: '100%', maxWidth: 460, alignSelf: 'center', alignItems: 'stretch',
        elevation: 8, shadowColor: '#7C3AED', shadowOpacity: 0.1,
        shadowRadius: 24, shadowOffset: { width: 0, height: 12 },
    },
    ...
    resultsModalContent: {
        backgroundColor: '#FFF', borderRadius: 32, padding: 24,
        width: '100%', maxWidth: 460, alignSelf: 'center', alignItems: 'center',
        elevation: 8, shadowColor: '#7C3AED', shadowOpacity: 0.1,
        shadowRadius: 24, shadowOffset: { width: 0, height: 12 },
    },
    ...
    promptModalContent: {
        ...
        width: '100%', maxWidth: 460, alignSelf: 'center', alignItems: 'center', elevation: 8,
