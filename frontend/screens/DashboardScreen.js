...
function StatCard({ icon, label, value, color, width }) {
    return (
        <View style={[styles.statCard, { borderLeftColor: color, width }]}>
    ...
    return (
        ...
        >
            <View style={styles.sidebarOverlay}>
                ...
                <View style={[styles.sidebarContainer, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 24 }]}>
                    {/* Sidebar Header */}
              ...
              <ContentWell maxWidth="wide">
                ...
                <View style={styles.statsGrid}>
                    {mockStats(t).map((stat, i) => (
                        <StatCard key={i} {...stat} width={statCardW} />
                    ))}
                </View>
                ...
                <View
                    style={styles.card}
                    onLayout={(e) => setBarBoxW(e.nativeEvent.layout.width)}
                >
                ...
                {/* ── Health Indicators ── */}
                <View style={[styles.indicatorRow, r.isCompact && { flexDirection: 'column' }]}>
                    <View
                        style={[
                            styles.card,
                    ...
                    <View
                        onLayout={(e) => setPieBoxW(e.nativeEvent.layout.width)}
                        style={[
                            styles.card,
                            r.isCompact
                                ? { marginBottom: 0, marginTop: 12 }
                                : { flex: 0.9, marginBottom: 0, marginLeft: 12 },
                        ]}
                    >
                        <Text style={styles.cardTitle}>
                            {t('Risk Level')}
                ...
                <View style={styles.quickActions}>
                    <TouchableOpacity
                        style={[
                            ...
                            { backgroundColor: '#7C3AED', width: quickCardW },
                        ]}
                        onPress={() =>
                            navigation.navigate('Diary')
                        }
                    ...
                    <TouchableOpacity
                        style={[
                            styles.quickActionBtn,
                            { backgroundColor: '#0EA5E9', width: quickCardW },
                        ]}
                        onPress={() =>
                            navigation.navigate('Plan')
                        }
                    ...
                    <TouchableOpacity
                        style={[
                            styles.quickActionBtn,
                            { backgroundColor: '#10B981', width: quickCardW },
                        ]}
                        onPress={() =>
                            Toast.show({
                                type: 'success',
                    ...
                    <TouchableOpacity
                        style={[
                            styles.quickActionBtn,
                            { backgroundColor: '#F59E0B', width: quickCardW },
                        ]}
                        onPress={() =>
                    ...
                    <TouchableOpacity
                        style={[
                            styles.quickActionBtn,
                            { backgroundColor: '#E91E8C', width: quickCardW },
                        ]}
                        onPress={() =>
