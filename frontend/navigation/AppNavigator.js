            ...
            <TouchableOpacity key={route.key} style={s.tab} activeOpacity={0.75}
              ...
              {focused ? (
                <LinearGradient colors={[colors.lavenderDark, colors.roseDark]} style={s.activeChip}>
                  ...
                  <Text style={[s.activeLabel, labelStyle]} numberOfLines={1} adjustsFontSizeToFit>{tab.label}</Text>
                </LinearGradient>
              ) : (
                <View style={s.inactiveChip}>
                  <Text style={s.inactiveIcon}>{tab.icon}</Text>
                  <Text style={[s.inactiveLabel, labelStyle]} numberOfLines={1} adjustsFontSizeToFit>{tab.label}</Text>
                </View>
              )}
            </TouchableOpacity>
          );
